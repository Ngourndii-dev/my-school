        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
              Welcome to our school , where academic excellence and the personal developmet of each student are our priorities.
              OUr  school offers a stimulating and caring environment , coductive to the success of every student 
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              >
                Get Ready to discover our school
              </a>
              <a href="#" className="text-sm/6 font-semibold text-gray-900">
